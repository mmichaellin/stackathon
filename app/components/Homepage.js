  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <audio src="./sounds/C.wav" ref={this.a2} />
        <audio src="./sounds/D.wav" ref={this.s2} />
        <audio src="./sounds/E.wav" ref={this.d2} />
        <audio src="./sounds/F.wav" ref={this.f2} />
        <audio src="./sounds/G.wav" ref={this.g2} />
        <audio src="./sounds/A.wav" ref={this.h2} />
        <audio src="./sounds/B.wav" ref={this.j2} />
