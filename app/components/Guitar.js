  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <audio src="./sounds/guitarC.wav" ref={this.a2} />
        <audio src="./sounds/guitarD.wav" ref={this.s2} />
        <audio src="./sounds/guitarE.wav" ref={this.d2} />
        <audio src="./sounds/guitarF.wav" ref={this.f2} />
        <audio src="./sounds/guitarG.wav" ref={this.g2} />
        <audio src="./sounds/guitarA.wav" ref={this.h2} />
        <audio src="./sounds/guitarB.wav" ref={this.j2} />
